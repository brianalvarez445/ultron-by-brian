...
export function createOrbScene(container: HTMLElement): OrbSceneApi {
  ...
  // ——— COLORS ———
const C_BRIGHT = 0xff3333; // Bright Red
const C_MID    = 0x3399ff; // Electric Blue
const C_DIM    = 0xffcc33; // Gold
const C_FAINT  = 0x33ff66; // Neon Green
const C_HOT    = 0xaa33ff; // Purple
